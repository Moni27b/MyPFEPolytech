...
<html lang="fr">
  ...
  <body>
                ...
                <div id="navbar" class="navbar-collapse collapse">
                  <form class="navbar-form navbar-right" method="POST" action="Conn.php">
                      <div class="form-group">
                        <input type="text" placeholder="IPN" name="login" class="form-control">
                      </div>
    ...
    <div class="jumbotron">
      <div class="container">
        <h1>Bienvenue dans l'outil Tracker des appareils mobiles</h1>
        <p>Cet outil vous servira à collecter des donneés sur les appreils de mesure dans le Centre technique de Lardy</p>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <img src="img/Groupe_Renault.png" width="300" height="80"></img>
        </div>
      </div>
      ...
      <footer>
        <p>&copy; 2016 Mounir Benbouhou, Renault, Inc.</p>
      </footer>
    </div> <!-- /container -->
