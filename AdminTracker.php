        ...
        <div class="row">
          <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
              ...
              <li class="active"><a href="#">Tracker <span class="sr-only">(current)</span></a></li>
          ...
          <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
               ...
               <!-- Table Trackers -->
               <h2 class="sub-header">Table Tracker</h2>
               ...
               <div class="panel-body">
                 ...
                 <div class="panel panel-default filterable">
                   <div class="panel-heading">
                     ...
                     <?php include("btn/btn_add_Tracker.php"); ?>
               ...
               <table id="example" class="table table-bordered">
                 <thead>
                   <tr  class="filters">
                        <th><input type="text" class="form-control" placeholder="Id Tracker" disabled></th>
                        <th><input type="text" class="form-control" placeholder="Adresse Mac" disabled></th>
                        <th><input type="text" class="form-control" placeholder="Id Appareil" disabled></th>
                        <th></th>
                    </tr>
                </thead>
               <?php while($row = $resultTracker->fetch()) {?>
                 <tr>
                   <td><? echo $row['Id_Tracker']; ?></td>
                   <td><? echo $row['Adresse_Mac']; ?></td>
                   <td><? echo $row['Id_Appareil']; ?></td>
                   <td><a href="delTracker.php?id=<?echo $row['Id_Tracker'];?>"onclick="return confirm('Vous voulez vraiment supprimer !');">Delete</a></td>
                 </tr>
                 <?php } ?>
               </table>
              </div>
